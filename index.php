    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/homeTwo.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="img/homeOne.jpg" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
        ...
        <div class="row g-0 feature-row">
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                <div class="feature-item border h-100 p-5">
                    ...
                    <p class="mb-0">Our courses are accessible to learners globally, creating a diverse and inclusive learning community.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                <div class="feature-item border h-100 p-5">
                    ...
                    <p class="mb-0">Our highly certified instructors will bring a wealth of knowledge and real-world experience to your learning journey.</p>
                </div>
            </div>
